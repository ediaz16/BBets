...
The mean profit as shown on thr graph is around 281.
...
# nSim simulations
for (i in 1:nSims){
  saveResults [i] = BrLw(35,4.25,637)
  #historical did this 637 times
}
hist(saveResults)
```
...
The fair amount that soud be paid out is.4.25 (-98,122)
...
The graph shows Brownlow he is making less money on a bigger size class.
